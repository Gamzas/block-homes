...
library IterableMapping {
    ...
    function getValue(itmap storage self, bytes32 key) internal view returns (bytes memory) {
    ...
    function iterate_get(itmap storage self, uint256 keyIndex) internal view returns (bytes32 key, bytes memory value) {
