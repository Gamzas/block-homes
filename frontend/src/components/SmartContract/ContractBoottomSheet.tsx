    ...
    <div>
      <ContractBottomContainer $height={isOpen? 42:23}>
        {isOpen ?(<>
          ...
          <div className='understand-text-second'>계약서 내용을 제대로 이해하지 못했는데도 이해했다고 확인하는 경우, 추후 해당 내용과 관련한 권리구제가 어려울 수 있어요.</div>

          <Button $secondary onClick={toggleSheet} style={{marginBottom:'10px'}} >닫기</Button>
