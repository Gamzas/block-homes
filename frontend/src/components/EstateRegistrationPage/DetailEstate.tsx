  ...
  return (
    <d.DetailEstateContainer>
      <d.DetailEstateSession>
        ...
        <d.DetailEstateWrapperInput>
          ...
          <d.DetailEstateToggleButton $isSelected={isSelected}>
            <div className="left" onClick={() => handleHaveElevatorToggleButtonClick(true)}>유</div>
            <div className="right" onClick={() => handleHaveElevatorToggleButtonClick(false)}>무</div>
      ...
      <d.DetailEstateSession>
        ...
        {!isNoParkngRate && <d.DetailEstateInputNumber>
          <input
            className="input-number"
            type="number"
            min="1"
        ...
        <d.DetailEstateOptions>
          {options.map((option, index) => (
            <d.DetailEstateOption
              ...
              onClick={() => handleAdditionalOptionCategoryListButtonClick(index)}
            >
              {option}
            </d.DetailEstateOption>
          ))}
